...
public class LoreEnchantRecipe extends InputRecipe {
	...
	public LoreEnchantRecipe(String identifier, String name, int productionTime, int uses, ItemMap input, ItemMap tool,
			List<String> appliedLore, List<String> overwritenLore) {
